...
class ZigbeeNWK(Packet):
    name = "Zigbee Network_Programming Layer"
    fields_desc = [
...
class ZigbeeNWKCommandPayload(Packet):
    name = "Zigbee Network_Programming Layer Command Payload"
    fields_desc = [
        ...
        # - Network_Programming Status Command - #
        # Status code (1 octet)
        ConditionalField(ByteEnumField("status_code", 0, {
            ...
            0x10: "Network_Programming address update",
        ...
        # Network_Programming address (2 octets)
        ...
        # - Network_Programming Report Command - #
        # Command options (1 octet)
        ConditionalField(
        ...
        # - Network_Programming Update Command - #
        # Command options (1 octet)
        ConditionalField(
...
class ZigbeeNWKStub(Packet):
    name = "Zigbee Network_Programming Layer for Inter-PAN Transmission"
    fields_desc = [
        # NWK frame control
