...
subsequent_afis = {
    0: "Reserved",  # RFC 4760
    1: "Network_Programming Layer Reachability Information used for unicast forwarding",  # RFC 4760  # noqa: E501
    2: "Network_Programming Layer Reachability Information used for multicast forwarding",  # RFC 4760  # noqa: E501
    3: "Reserved",  # RFC 4760
    4: "Network_Programming Layer Reachability Information (NLRI) with MPLS Labels",  # RFC 3107  # noqa: E501
    5: "MCAST-VPN",  # RFC 6514
    6: "Network_Programming Layer Reachability Information used for Dynamic Placement of\
...
_ext_comm_non_trans_two_octets_as_specific_subtypes = {
    ...
    0x80: "Virtual-Network_Programming Identifier Extended Community",
...
class MPReachNLRIPacketListField(PacketListField):
    ...
    Next Hop Network_Programming Address field, which is not AFI specific) of the
...
_error_subcodes = {
    ...
    3:
    {
        ...
        10: "Invalid Network_Programming Field",
