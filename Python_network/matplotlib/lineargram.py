...
if __name__ == '__main__':
    ...
    r1 = [(date1, random.randrange(100))]
    r2 = [(date1, random.randrange(100))]
    for x in range(1, 8):
        num1 = random.randrange(100)
        num2 = random.randint(1, 100)
        if r1 and r2:
            r1.insert(0, (date1 - datetime.timedelta(hours=x), num1))
            r1.append((date1 + datetime.timedelta(hours=x), num1))
            r2.insert(0, (date1 - datetime.timedelta(hours=x), num2))
            r2.append((date1 + datetime.timedelta(hours=x), num2))
    mat_lineargram(r1, r2)
