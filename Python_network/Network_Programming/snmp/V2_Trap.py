# -*- coding: utf-8 -*-
"""
Created on 2019/7/27 16:33

File name   V2_Trap.py
...
def analysis(info):
    # 分析Trap信息字典函数
    # 下面是这个大字典的键值与嵌套的小字典
    # 1.3.6.1.2.1.14.10.1.6 ospf状态
    # {'value': 'ObjectSyntax', 'simple': 'SimpleSyntax', 'integer-value': '8'}
    # 1.3.6.1.2.1.14.10.1.3 ospf邻居route-id
    # {'value': 'ObjectSyntax', 'application-wide': 'ApplicationSyntax', 'ipAddress-value': '3.3.3.3'}
    if '1.3.6.1.2.1.14.10.1.6' in info.keys():
        if info["1.3.6.1.2.1.14.10.1.6"]['integer-value'] == '8':
            print('OSPF Neighbor route-id {0: ^10}  is full'.format(info['1.3.6.1.2.1.14.10.1.3']['ipAddress-value']))
        elif info["1.3.6.1.2.1.14.10.1.6"]['integer-value'] == '1':
            print('OSPF Neighbor route-id {0: ^10}  is down'.format(info['1.3.6.1.2.1.14.10.1.3']['ipAddress-value']))
