...
IEType = {1: "IMSI",
             ...
             80: "Bearer QoS",
             82: "RAT",
             83: "Serving Network_Programming",
             86: "ULI",
             87: "F-TEID",
             93: "Bearer Context",
             94: "Charging ID",
...
class IE_ServingNetwork(gtp.IE_Base):
    name = "IE Serving Network_Programming"
...
PCO_PROTOCOL_TYPES = {
    ...
    0x0005: 'MS Support of Network_Programming Requested Bearer Control indicator',
...
class PCO_SOF(PCO_Option):
    name = "PCO MS Support of Network_Programming Requested Bearer Control indicator"
    fields_desc = [ShortEnumField("type", None, PCO_PROTOCOL_TYPES),
                   ByteField("length", 0),
                   ]
