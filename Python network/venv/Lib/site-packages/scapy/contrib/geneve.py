...
# scapy.contrib.description = Generic Network_Programming Virtualization Encapsulation (GENEVE)
# scapy.contrib.status = loads

"""
Geneve: Generic Network_Programming Virtualization Encapsulation
